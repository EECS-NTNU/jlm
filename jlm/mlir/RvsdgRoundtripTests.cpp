...
ROUNDTRIP_TEST(TestIndirectCall2, ::jlm::llvm::IndirectCallTest2)
ROUNDTRIP_TEST(TestDelta1, ::jlm::llvm::DeltaTest1)
ROUNDTRIP_TEST(TestDelta2, ::jlm::llvm::DeltaTest2)
ROUNDTRIP_TEST(TestDelta3, ::jlm::llvm::DeltaTest3)
ROUNDTRIP_TEST(TestEscapedMemory1, ::jlm::llvm::EscapedMemoryTest1)
